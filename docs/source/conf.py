...
latex_documents = [
    (master_doc, 'rnaiutilities.tex', 'rnaiutilities Documentation',
...
man_pages = [
    (master_doc, 'rnaiutilities', 'rnaiutilities Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rnaiutilities', 'rnaiutilities Documentation',
     author, 'rnaiutilities', 'One line description of project.',
     'Miscellaneous'),
]
